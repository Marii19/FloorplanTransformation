...
apptainer run --nv --bind git/FloorplanTransformation:/mnt/code --bind ${DATAPOOL3}/datasets/bimkit:/mnt/datasets --bind ${LOCAL_JOB_DIR}:/mnt/output git/FloorplanTransformation/apptainer/pytorch.sif bash /mnt/code/apptainer/train.sh
cd ${LOCAL_JOB_DIR}
