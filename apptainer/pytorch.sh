...
apptainer run --nv --bind ${DATAPOOL3}/datasets/bimkit:/mnt/datasets --bind ${LOCAL_JOB_DIR}:/mnt/output git/FloorplanTransformation/apptainer/pytorch.sif --dataset-path /mnt/cubicasa
cd ${LOCAL_JOB_DIR}
