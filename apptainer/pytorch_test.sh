...
apptainer run --nv --bind git/FloorplanTransformation:/mnt/code --bind ${DATAPOOL3}/datasets/cubicasa_small:/mnt/datasets/cubicasa --bind ${LOCAL_JOB_DIR}:/mnt/output git/FloorplanTransformation/apptainer/pytorch.sif 
